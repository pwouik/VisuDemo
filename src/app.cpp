...
App::App(int w,int h)
{
    ...
    */
    ...
    attractor_renderer = new AttractorRenderer(this);
}
...
void App::run(){
    while (!glfwWindowShouldClose(window)) {
        ...
        case AttractorMode:{
            attractor_renderer->draw_ui();
            attractor_renderer->render(width, height, pos, inv_camera_view, old_view, proj, light_pos);
            break;
        }
        }
